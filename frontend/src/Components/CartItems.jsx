          ...
          <div className="grid gap-4 md:grid-cols-[0.9fr_1.6fr_1fr_1fr_1fr_1fr_0.6fr] md:items-center">
            <div className="flex items-center gap-4">
              ...
              <div className="md:hidden">
                ...
                <p className="mt-2 inline-flex rounded-full bg-orange-100 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-orange-700">Size {size}</p>
              </div>
            </div>
            ...
            <div className="w-fit rounded-full bg-orange-100 px-4 py-2 text-sm font-semibold text-orange-700 shadow-sm">{size}</div>
            <button className="w-fit rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm">{quantity}</button>
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr]">
        <div className="order-2 rounded-3xl border border-slate-200 bg-slate-50 p-6 lg:order-1">
          ...
          <div className="mt-4 flex flex-col gap-3 sm:flex-row">
            <input type="text" placeholder="Promo code" className="h-12 flex-1 rounded-2xl border border-slate-200 bg-white px-4 text-sm outline-none transition focus:border-slate-400" />
            <button className="h-12 rounded-2xl bg-slate-900 px-6 text-sm font-semibold text-white transition hover:bg-slate-700">Submit</button>
          </div>
        </div>
